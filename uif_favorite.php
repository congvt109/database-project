...
<div class="container bootstrap snippet">
  ...
  <div class="row">
    <div class="col-sm-4">
      <!--left col-->
      <div class="text-center">
        <img src="<?= $currentUser['avatar'] ?>" class="page-img avatar img-circle img-thumbnail" alt="avatar"
          ...
          <tr id="table-row">
            ...
            <td>
              <a class="book-link" href="book_detail.php?id=<?= $row['id'] ?>" class="card-img">
                <img class="page-img" style="width: 80px;height: 100px;" src="./<?= $row['image'] ?>"
                  alt="<?= $row['tittle'] ?>" title="<?= $row['tittle'] ?>">
              </a>
            </td>
            ...
            <td style="text-align: center"><a class="fa fa-trash" href="./uif_favor_del.php?id=<?= $row['id'] ?>"></a>
            </td>
          </tr>
        </a>
        <?php
