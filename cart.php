...
<div class="container">
  ...
  <?php } else { ?>
  <div class="back-to-shop"><a href="book.php" class="fa fa-undo" style="padding: 5px; margin-bottom: 10px;"> Quay lại
      Cửa hàng</a></div>
  <?php
    if ($GLOBALS['changed_cart'] && $soluong != 0) { ?>
  <!-- Check nhap qua quantity neu la true: so luong khach nhap lon qua-->
  <div class="content-container">
    <div class="box-content">
      <h3>Số lượng sản phẩm tồn kho không đủ. Vui lòng <a href="javascript:window.history.go(-1)">tải lại</a> giỏ hàng
      </h3>
    </div>
  </div>
  <?php
          ...
          <div class="row" style="border-top: 1px solid rgba(0,0,0,.1);">
            <div class="detail-container row main align-items-center">
              ...
              <div style="padding-right: 0;">
                <input style="width: 70px;" type="number" value="<?= $_SESSION['cart'][$row['id']] ?>"
                  name="quantity[<?= $row['id'] ?>]" size=2 style="padding:0;text-align:center" />
              </div>
              <div><?= number_format(($row['price'] - $row['discount']) * $_SESSION["cart"][$row['id']], 0, ",", ".") ?>
              </div>
      ...
      <div class="row">
        <div class="col-md-11 summary" style="margin:auto;">
          ...
          <div class="row" style="border-top: 1px solid rgba(0,0,0,.1); padding: 2vh 0;">
            <div class="col-6">
              <p style="margin-bottom: 10px">Người nhận hàng</p> <input style="padding: 5px; border-radius: 3px"
                type="text"
                value="<?= isset($row_user['last_name']) ? $row_user['first_name'] . " " . $row_user['last_name'] : "" ?>"
                name="fullname" placeholder="Nhập Tên">
            </div>
            <div class="col-6">
              <p style="margin-bottom: 10px">Số điện thoại</p> <input style="padding: 5px; border-radius: 3px"
                type="text" value="<?= isset($row_user['phone']) ? $row_user['phone'] : "" ?>" name="phone"
                placeholder="Nhập SĐT">
            </div>
          </div>
          <div class="row" style="border-top: 1px solid rgba(0,0,0,.1); padding: 2vh 0;">
            <div class="col-6">
              <p style="margin-bottom: 10px">Địa chỉ</p> <input style="padding: 5px; border-radius: 3px" type="text"
                value="<?= isset($row_user['address']) ? $row_user['address'] : "" ?>" name="address"
          ...
          <div class="row" style="border-top: 1px solid rgba(0,0,0,.1); padding: 2vh 0;">
            <p style="margin-bottom: 10px">Ghi chú: </p><textarea style="padding: 5px; border-radius: 3px" name="note"
              cols="128" rows="6" style="margin:auto;"></textarea>
          </div>
          <div class="row" style="justify-content:center; border-top: 1px solid rgba(0,0,0,.1); padding: 2vh 0;">
            <p>TỔNG THANH TOÁN : <b class="text-danger"
                style="font-size:1.5rem"><?= isset($total) ? number_format($total, 0, ",", ".") : "" ?></b></p>
          </div>
          <div class="button-container">
