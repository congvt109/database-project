    ...
    <div class="icons">
      ...
      <ul class="user_navbar">
        ...
        <li><a href="#" class="avatar"><img
              src="./<?= isset($currentUser['avatar']) ? $currentUser['avatar'] : "assets/image/user/user.png" ?>"
              alt="" style="width: 40px;height:40px;border-radius: 100%;"></a></li>
        <li id="has_subnav">
