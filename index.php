  ...
  <div class="row">
    ...
    <div class="swiper books-slider">
      <div class="swiper-wrapper">
        ...
        <a href="book_detail.php?id=<?= $book1['id'] ?>" class="swiper-slide"><img src="<?= $book1['image'] ?>" alt=""
            style="margin-bottom: 14px;"></a>
        <?php } ?>
      </div>
  ...
  <div class="swiper featured-slider">
    ...
    <div class="swiper-wrapper">
      ...
      <div class="swiper-slide box">
        ...
        <div class="image">
          <a href="book_detail.php?id=<?= $book2['id'] ?>"><img src="./<?= $book2['image'] ?>"
              alt="<?= $book2['tittle'] ?>"></a>
        </div>
        <div class="content">
          <h3><?= $book2['tittle'] ?></h3>
          <div class="price"><?= number_format($book2['price'] - $book2['discount'], 0, ",", ".") ?>đ
            <span><?= number_format($book2['price'], 0, ",", ".") ?>đ</span>
          </div>
...
<section class="arrivals" id="arrivals">
  ...
  <div class="swiper arrivals-slider">
    ...
    <div class="swiper-wrapper">
      ...
      <div class="swiper-slide box">
        <div class="image">
          <a href="book_detail.php?id=<?= $book3['id'] ?>"><img src="./<?= $book3['image'] ?>"
              alt="<?= $book3['tittle'] ?>"></a>
        </div>
        <div class="content">
          <h3><?= $book3['tittle'] ?></h3>
          <div class="price"><?= number_format($book3['price'] - $book3['discount'], 0, ",", ".") ?>đ
            <span><?= number_format($book3['price'], 0, ",", ".") ?>đ</span>
          </div>
          <br>
          <button data-id="<?= $book3['id'] ?>" class="btn-add-to-cart btn btn-lg btn-outline-primary text-uppercase"
  ...
  <div class="swiper reviews-slider">
    ...
    <div class="swiper-wrapper">
      ...
      <div class="swiper-slide box">
        ...
        <h3>Noobmaster69</h3>
        <p>Mình thích cách sắp xếp ở đây, tầng 1 có khá nhiều sácht, nên ai muốn tìm những thể loại mình thích thì có
          thể tham khảo. Riêng mình thì mình thích tầng trên cùng, có nhiều cuốn sách kén người đọc vì to và nặng. Có
          các thể loại nhân chủng, chính trị, xã hội. Điểm cộng lớn nhất ở đây là cách sắp xếp sách.</p>
        <div class="stars">
      ...
      <div class="swiper-slide box">
        ...
        <h3>Dan Hauer</h3>
        <p>Mình thích không khí của tiệm này, nằm một mình, không chen chúc với các tiệm sách cũ khác. Nên tránh được
          cảm giác “lựa hàng” khi đi mua sách. Đại loại là không ưng ở đây thì ghé qua chỗ khác… Bác chủ thoải mái, sách
          chuyên môn cũng có nhiều. Nếu có dịp đi đường sách cũ thì sau mình sẽ làm thêm review.</p>
        <div class="stars">
          <i class="fas fa-star"></i>
          <i class="fas fa-star"></i>
          <i class="fas fa-star"></i>
      ...
      <div class="swiper-slide box">
        ...
        <h3>John Wick</h3>
        <p>Hiệu sách dành cho người đi làm là đây. Tầng 1 chọn sách, tầng 2 tha hồ chọn văn phòng phẩm, bút, sổ tay, giá
          phải chăng hơn các tiệm văn phòng phẩm khác. Nói chung là cách sắp xếp không gian sách ở tầng 1 khá là hiện
          đại, phù hợp cho người lớn tới lựa sách, chỗ gửi xe rộng, các đồ dùng văn phòng ở đây cũng nhiều.</p>
        <div class="stars">
          <i class="fas fa-star"></i>
          <i class="fas fa-star"></i>
          <i class="fas fa-star"></i>
